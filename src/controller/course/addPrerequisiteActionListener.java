...
public class addPrerequisiteActionListener implements ActionListener {

    private MainWindow mainWindow;
    private StudentRecordSystem srs;

    public addPrerequisiteActionListener(MainWindow mainWindow,
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        if (courses == null) {
            JOptionPane.showMessageDialog(null, "There are no courses.",
                    "Add Prerequisite Error", JOptionPane.ERROR_MESSAGE);
        } else {
            ...
            String[] input = SwingInput.showComboDialog(mainWindow,
                    "Add Prerequisite", 300, new String[] { "Course",
            ...
            if (input != null) {
                try {
                    ...
                    String prerequisiteCourseId = getIdFromCollection(courses,
                            input[1]);
                    srs.addPrerequisite(courseId, prerequisiteCourseId);
                    mainWindow.refresh();
                } catch (SRSException e) {
                    JOptionPane.showMessageDialog(
                            mainWindow, e.getMessage(), "Add Prerequisite Error",
