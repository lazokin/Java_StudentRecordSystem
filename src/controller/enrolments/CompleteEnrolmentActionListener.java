...
public class CompleteEnrolmentActionListener implements ActionListener {

    private MainWindow mainWindow;
    private StudentRecordSystem srs;

    public CompleteEnrolmentActionListener(MainWindow mainWindow,
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        if (currentEnrolments.isEmpty()) {
            ...
            String[] input = SwingInput.showComboTextDialog(mainWindow,
                "Complete Enrolment", 300,
                new String[] { "Current Enrolment" }, new String[] { "Grade" },
                comboBoxContents);
            if (input != null) {
                try {
                    ...
                    srs.completeEnrolment(studentId, courseOfferingId, grade);
                    mainWindow.refresh();
